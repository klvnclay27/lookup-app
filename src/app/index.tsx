...
const ACTIONS: Action[] = [
  ...
  { label: 'Rhythm', route: '/music', icon: { ios: 'music.note', android: 'music_note', web: 'music_note' }, color: '#B14EC2', tint: '#FAEAFC' },
  ...
  useEffect(() => {
    ...
    async function loadDashboard() {
      try {
        ...
        setPlaylist(data.previews?.music?.playlist ?? 'Rhythm unavailable');
